...
?>
		...
		<div class="productos">
				<div class="card">
				<img src="imagenes de productos/1a35ac68c6221d2a90f4d317a8165602.jpg" alt="Imagen de camisa gamer">
					<div class="info-producto">
					<h3>SILLA GAMER DEPORTIVA VORAGO CGC300-RD - ROJA / TELA</h3>
					</div>
					<p>$2,299.00</p>
				</div>
			</div>
		<div class="productos">
				<div class="card">
				<img src="imagenes de productos/8555450fc873cb267e06b7c1a8f8633d.jpg" alt="Imagen de camisa gamer">
					<div class="info-producto">
					<h3>Mouse Inalambrico Gamer Logitech PRO X SUPERLIGHT Black / 25600 DPI / Wireless LIGHTSPEED / Sensor HERO /5 Botones / 910-005879 /</h3>
					</div>
					<p>$1,699.00</p>
					<span class="rating">★★★★★</span>
			<a href="#" class="add-cart">Añadir a carrito</a>
		...
		<div class="card">
			<div class="img-container">
				<img class="imagen" id="nuevo-estilo" src="imagenes de productos/nuevoyo.jpg" alt="soy yioooo">
			</div>
				<div class="info-producto">
			<h3>
			Prueba para neuvo estilo de cards jeje
			</h3>
					</div>
			<p>GRATIS</p>
